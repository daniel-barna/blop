...
namespace blop
{
  ...
  class color_mapping_base : public factory_base<color_mapping_base>
  {
  public:
  ...
  public:
    smartptr<color_mapping_base> clone() const
    {
      //      return new color_mapping_interpolated(*this);
      return color_mapping_interpolated::create(*this);
    }
  ...
  {
    FACTORY(color_mapping_function);
  private:
    void *p2f_cint_;
  ...
  public:
    ...
    smartptr<color_mapping_base> clone() const 
    {
      ...
      return color_mapping_function::create(*this);
    }
  ...
  class graph_drawer : public factory_base<graph_drawer>
  {
    FACTORY(graph_drawer);
  public:
    // These two member-functions return the blop-function, which
    // calculates the values to be used as x- or y- coordinates

    virtual function get_x(smartptr<plottable>) const;
    virtual function get_y(smartptr<plottable>) const;

    virtual void set_ranges(plottable::ptr g, smartptr<axis> x, smartptr<axis> y) = 0;
    virtual void draw(plottable::ptr g,smartptr<frame> f,terminal *t) = 0;
    ...
    virtual smartptr<graph_drawer> clone() const = 0;
    virtual void prepare_for_draw(plottable::ptr ,smartptr<frame> f, int count) = 0;
    ...
    virtual void setup_when_added(smartptr<plottable> p, smartptr<frame> f) {}
  ...
  public:
    ...
    graphd_colorscale &color_mapping(void *p)
    {
      ...
      color_mapping_ = color_mapping_function::create(p);
      return *this;
    }
    ...
    {
      //      if(color_mapping_) delete color_mapping_;
      color_mapping_ = color_mapping_interpolated::create(colors,values,values_normalized);
      return *this;
    }
    graphd_colorscale &color_mapping(const std::vector<blop::color> &colors)
    {
      //      if(color_mapping_) delete color_mapping_;
      color_mapping_ = color_mapping_interpolated::create(colors);
      return *this;
    }
    ...
    virtual smartptr<color_legend> get_colorlegend() { return colorlegend_; }
  ...
  public:
    ...
    void set_ranges(plottable::ptr g, smartptr<axis> x, smartptr<axis> y);
    void draw(plottable::ptr g,smartptr<frame> f,terminal *t);
    virtual void draw_sample(const length &x,
                             const length &y,
                             const length &size,
                             smartptr<plottable> style,
    ...
    smartptr<graph_drawer> clone() const;
    void prepare_for_draw(plottable::ptr , smartptr<frame>, int) {};
  ...
  public:
    ...
    virtual void set_ranges(plottable::ptr g, smartptr<axis> x, smartptr<axis> y);
    void draw(plottable::ptr g, smartptr<frame>, terminal *t);
    void draw_sample(const length &x,
                     ...
                     terminal *);
    smartptr<graph_drawer> clone() const;
    void prepare_for_draw(plottable::ptr , smartptr<frame>, int count);
  ...
  public:
    ...
    void draw_sample(const length &x, const length &y,
                     const length &samplen, smartptr<plottable> s, terminal *t);
    virtual bool uses_pointcolor() const { return false; }
    virtual bool uses_pointsize() const { return false; }
  };
  ...
  private:
    ...
    void get_functions(smartptr<plottable> g,
  ...
  class yerrorbars : public errorbars
  {
    FACTORY(yerrorbars);
  public: 
    yerrorbars() : errorbars(false,false,true,false) {}
  };
  ...
  class syerrorbars : public errorbars
  {
    FACTORY(syerrorbars);
  public: 
    syerrorbars() : errorbars(false,false,true,true) {}
  };
  ...
  class xerrorbars : public errorbars
  {
    FACTORY(xerrorbars);
  public: 
    xerrorbars() : errorbars(true,false,false,false) {}
  };
  ...
  class sxerrorbars : public errorbars
  {
    FACTORY(sxerrorbars);
  public: 
    sxerrorbars() : errorbars(true,true,false,false) {}
  };
  ...
  class xyerrorbars : public errorbars
  {
    FACTORY(xyerrorbars);
  public: 
    xyerrorbars() : errorbars(true,false,true,false) {}
  };
  class sxyerrorbars : public errorbars
  {
    FACTORY(sxyerrorbars);
  public: 
    sxyerrorbars() : errorbars(true,true,true,true) {}
  };
  ...
  private:
    bool x_,y_;
    smartptr<graph_drawer> drawer_;
  public:
    function get_x(smartptr<plottable> g) const { return drawer_->get_x(g); }
    function get_y(smartptr<plottable> g) const { return drawer_->get_y(g); }
  ...
  /*
    ...
    smartptr<graph_drawer> clone() const;
    void prepare_for_draw(plottable::ptr , frame *, int count);
    int req_components() const {return 3;}
  ...
  */
  ...
  protected:
    ...
    friend class hist;
    void calc(smartptr<plottable> g, smartptr<axis> xaxis, smartptr<axis> yaxis);
    static bool default_frame_foreground_;
    static bool default_grid_foreground_;
    bool frame_foreground_, grid_foreground_;
    void get_functions(smartptr<plottable> g,
  ...
  public:
    ...
    smartptr<color_legend> legend() { return get_colorlegend(); }
  ...
  private:
    void init_();
  public:
    smartptr<graph_drawer> clone() const { return cboxes::create(*this); }
    cboxes();
    ...
    smartptr<color_legend> legend() { return csboxes::legend(); }
  ...
  private:
    void init_();
  public:
    smartptr<graph_drawer> clone() const { return sboxes::create(*this); }
    sboxes();
  ...
  private:
    bool x_,y_;
    function get_x1_(smartptr<plottable>) const;
    function get_x2_(smartptr<plottable>) const;
    function get_y1_(smartptr<plottable>) const;
    function get_y2_(smartptr<plottable>) const;
  public:
  ...
  class xbands : public bands
  {
    FACTORY(xbands);
  public: 
    xbands() : bands(true,false) {}
  };
  class ybands : public bands
  {
    FACTORY(ybands);
  public: 
    ybands() : bands(false,true) {}
  };
  ...
  public:
    ...
    void draw(plottable::ptr g, smartptr<frame>, terminal *t);
    bool draws_sample() const { return false; }
    smartptr<graph_drawer> clone() const {return mosaic::create(*this);}
    void prepare_for_draw(plottable::ptr , smartptr<frame>, int count);
    int req_components() const { return 3; }
  ...
  class isolines : public graph_drawer
  {
    FACTORY(isolines);
  private:
    bool skip_(const var &, const var &, const var &, smartptr<axis> xaxis, smartptr<axis> yaxis,
  ...
  public:
    ...
    void setup_when_added(smartptr<plottable>, smartptr<frame>);
